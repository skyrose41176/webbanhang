...
namespace WebShop.PayPalHelpers
{
    public class PayPalPaymentExecutedResponse{
        ...
        public class Transaction{
            ...
            public Related_Rescources[] related_rescources{get;set;}
        }

        public class Amount{
            public string total{get;set;}
            public string currency{get;set;}
            public Detais detais{get;set;}
        }
        public class Detais{
        ...
        public class Item_List{
            public Shipping_Address1 Shipping_Address1{get;set;}
        }
        ...
        public class Related_Rescources{
